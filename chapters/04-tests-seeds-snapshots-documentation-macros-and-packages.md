...
![그림 4-1. 품질 계층과 재사용 계층의 전체 지도](./images/ch04_quality-and-reuse-map.svg)
...
![그림 4-2. seed와 snapshot의 차이, 그리고 snapshot의 시간 축](./images/ch04_seed-vs-snapshot-timeline.svg)
