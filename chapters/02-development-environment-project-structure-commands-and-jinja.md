...
![그림 2-1. 개발 환경은 코드·연결·엔진·실행 경로의 조합이다](./images/ch02_fig01_local-dev-stack.svg)
...
![그림 2-2. companion 프로젝트를 네 축으로 읽는 방법](./images/ch02_fig02_project-anatomy.svg)
...
![그림 2-3. 초보자가 먼저 익혀야 하는 명령 흐름](./images/ch02_fig03_command-workflow.svg)
